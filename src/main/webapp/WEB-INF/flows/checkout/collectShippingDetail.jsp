		...
		<form:form modelAttribute="order.shippingDetail" class="form-horizontal">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="shippingDate" />Data wysyłki (dd/mm/yyyy)</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="areaName" path="shippingAddress.city" type="text"
							class="form:input-large" />
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						<button id="back" class="btn btn-default" name="_eventId_backToCollectCustomerInfo">Powrót</button>
